...
use sp_runtime::{
	traits::{Block as BlockT, NumberFor, HashFor},
	ConsensusEngineId,
};
...
impl<B, H, P> NetworkWorker<B, H, P>
	where
		B: BlockT + 'static,
		H: ExHashT,
...
pub struct NetworkWorker<B: BlockT + 'static, H: ExHashT, P: StorageProof<HashFor<B>> + 'static> {
...
impl<B, H, P> Unpin for NetworkWorker<B, H, P>
	where
		B: BlockT + 'static,
		H: ExHashT,
		P: StorageProof<HashFor<B>>,
...
struct NetworkLink<'a, B: BlockT, H: ExHashT, P: StorageProof<HashFor<B>> + 'static> {
	protocol: &'a mut Swarm<B, H, P>,
}

impl<'a, B, H, P> Link<B> for NetworkLink<'a, B, H, P>
	where
		B: BlockT,
		H: ExHashT,
		P: StorageProof<HashFor<B>>,
