...
use sc_service::{
	...
	RpcHandlers, ServiceComponents, TaskManager, client::FinalityProofClient,
};
...
pub fn new_full_base(
	...
	let ServiceComponents {
		...
		.with_finality_proof_provider(|client, backend| {
			...
			let provider = Arc::new(FinalityProofClient(client)) as Arc<dyn grandpa::StorageAndProofProvider<_, _>>;
...
type LightClient = sc_service::TLightClient<
	...
	RuntimeApi,
	node_executor::Executor,
	sc_client_api::GenesisBackend<node_primitives::Block>, // warn this contains static Simple Proof: TODO param it?
>;
...
pub fn new_light_base(config: Configuration) -> Result<(
	...
	>(config)?
		...
		.with_finality_proof_provider(|client, backend| {
			// GenesisAuthoritySetProvider is implemented for StorageAndProofProvider
			let provider = Arc::new(FinalityProofClient(client)) as Arc<dyn StorageAndProofProvider<_, _>>;
