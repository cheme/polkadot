...
impl<H: Hasher, Number: BlockNumber> Storage<H, Number> for InMemoryStorage<H, Number> {
	...
	fn get(&self, key: &H::Out, prefix: Prefix) -> Result<Option<DBValue>, String> {
		// TODO consider using specifically NoMeta and old layout here.
		match MemoryDB::<H>::get(&self.data.read().mdb, key, prefix) {
		...
		H: Hasher,
{
	...
	fn get(&self, key: &H::Out, prefix: Prefix) -> Result<Option<(DBValue, sp_trie::TrieMeta)>, String> {
