...
/// to the storage.
#[derive(Debug)]
pub struct ReadOnlyExternalities<'a, H, B>
	where
		H: Hasher,
		H::Out: Encode,
		B: Backend<H> + 'a,
...
impl<'a, H, B> ReadOnlyExternalities<'a, H, B>
	where
		H: Hasher,
		H::Out: Encode,
		B: Backend<H> + 'a,
...
impl<'a, H, B> Externalities for ReadOnlyExternalities<'a, H, B>
	where
		H: Hasher,
		H::Out: Encode,
		B: Backend<H> + 'a,
...
impl<'a, H, B> sp_externalities::ExtensionStore for ReadOnlyExternalities<'a, H, B>
	where
		H: Hasher,
		H::Out: Encode,
		B: Backend<H> + 'a,
